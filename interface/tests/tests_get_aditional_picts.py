...
from interface.management.commands.get_aditional_picts import Command
...
class Databasetests(TestCase):
    ...
    @patch("interface.management.commands.get_aditional_picts.Command.get_pictures_from_wikipedia",
           mock_request_api)
    def test_database_process(self):
        """Lauch the integration test with the two mocks"""
