...
class Service:
    ...
    def set_final_engine_context(
        self, color_top, form, color_under, ring, final_results
    ):
    ...
    def search_results_with_name(self, query):
        ...
        return (
            Mushroom.objects.filter(image__isnull=False)
            .filter(
                Q(espece__icontains=query) |
                Q(nom_vernaculaire__icontains=query))
            .order_by("espece")
        )
    ...
    def sort_by_edible_very_good(self):
        ...
        return (
            Mushroom.objects.filter(image__isnull=False)
            .filter(comestibilite__exact="bon comestible")
            .order_by("espece")
        )
    ...
    def sort_by_edible_good(self):
        ...
        return (
            Mushroom.objects.filter(image__isnull=False)
            .filter(comestibilite__exact="comestible")
            .order_by("espece")
        )
    ...
    def sort_by_edible_bad_good(self):
        ...
        return (
            Mushroom.objects.filter(image__isnull=False)
            .filter(comestibilite__exact="mauvais comestible")
            .order_by("espece")
        )
    ...
    def sort_by_edible_bad(self):
        ...
        return (
            Mushroom.objects.filter(image__isnull=False)
            .filter(comestibilite__exact="non comestible")
            .order_by("espece")
        )
    ...
    def sort_by_edible_deadly(self):
        ...
        return (
            Mushroom.objects.filter(image__isnull=False)
            .filter(comestibilite__exact="mortel")
            .order_by("espece")
        )
    ...
    def sort_by_edible_toxic(self):
        ...
        return (
            Mushroom.objects.filter(image__isnull=False)
            .filter(comestibilite__exact="toxique")
            .order_by("espece")
        )
    ...
    def sort_by_color_top_red(self):
        ...
        return (
            Mushroom.objects.filter(image__isnull=False)
            .filter(couleur_du_chapeau__icontains="rouge")
            .order_by("espece")
        )
    ...
    def sort_by_color_top_white(self):
        ...
        return (
            Mushroom.objects.filter(image__isnull=False)
            .filter(
                Q(couleur_du_chapeau__icontains="blanc")
                | Q(couleur_du_chapeau__icontains="creme")
                | Q(couleur_du_chapeau__icontains="gris")
            )
            .order_by("espece")
        )
    ...
    def sort_by_color_top_yellow(self):
        ...
        return (
            Mushroom.objects.filter(image__isnull=False)
            .filter(
                Q(couleur_du_chapeau__icontains="jaune")
                | Q(couleur_du_chapeau__icontains="orange")
            )
            .order_by("espece")
        )
    ...
    def sort_by_color_top_brown(self):
        ...
        return (
            Mushroom.objects.filter(image__isnull=False)
            .filter(
                Q(couleur_du_chapeau__icontains="brun")
                | Q(couleur_du_chapeau__icontains="noir")
            )
            .order_by("espece")
        )
    ...
    def sort_by_color_top_other(self):
        ...
        return (
            Mushroom.objects.filter(image__isnull=False)
            .filter(
                Q(couleur_du_chapeau__icontains="violet")
                | Q(couleur_du_chapeau__icontains="bleu")
                | Q(couleur_du_chapeau__icontains="rose")
                | Q(couleur_du_chapeau__icontains="vert")
            )
            .order_by("espece")
        )
    ...
    def sort_by_lamelles(self, first_sort):
        ...
        return (
            Mushroom.objects.filter(pk__in=first_sort)
            .filter(dessous_du_chapeau="lamelles")
            .order_by("espece")
        )
    ...
    def sort_by_tubes(self, first_sort):
        ...
        return (
            Mushroom.objects.filter(pk__in=first_sort)
            .filter(dessous_du_chapeau="tubes")
            .order_by("espece")
        )
    ...
    def sort_by_plis(self, first_sort):
        ...
        return (
            Mushroom.objects.filter(pk__in=first_sort)
            .filter(dessous_du_chapeau="plis fourchus")
            .order_by("espece")
        )
    ...
    def sort_by_aiguillons(self, first_sort):
        ...
        return (
            Mushroom.objects.filter(pk__in=first_sort)
            .filter(dessous_du_chapeau="aiguillons")
            .order_by("espece")
        )
    ...
    def sort_by_no_lamelles_and_tubes(self, first_sort):
        ...
        return (
            Mushroom.objects.filter(pk__in=first_sort)
            .filter(dessous_du_chapeau="ni lamelles ni tubes")
            .order_by("espece")
        )
    ...
    def sort_by_color_under_white(self, second_sort):
        ...
        return (
            Mushroom.objects.filter(pk__in=second_sort)
            .filter(
                Q(couleur_au_dessous_du_chapeau__icontains="blanc")
                | Q(couleur_au_dessous_du_chapeau__icontains="creme")
                | Q(couleur_au_dessous_du_chapeau__icontains="gris")
            )
            .order_by("espece")
        )
    ...
    def sort_by_color_under_brown(self, second_sort):
        ...
        return (
            Mushroom.objects.filter(pk__in=second_sort)
            .filter(
                Q(couleur_au_dessous_du_chapeau__icontains="brun")
                | Q(couleur_au_dessous_du_chapeau__icontains="noir")
            )
            .order_by("espece")
        )
    ...
    def sort_by_color_under_yellow(self, second_sort):
        ...
        return (
            Mushroom.objects.filter(pk__in=second_sort)
            .filter(
                Q(couleur_au_dessous_du_chapeau__icontains="jaune")
                | Q(couleur_au_dessous_du_chapeau__icontains="orange")
                | Q(couleur_au_dessous_du_chapeau__icontains="ocre")
            )
            .order_by("espece")
        )
    ...
    def sort_by_color_under_red(self, second_sort):
        ...
        return (
            Mushroom.objects.filter(pk__in=second_sort)
            .filter(couleur_au_dessous_du_chapeau__icontains="rouge")
            .order_by("espece")
        )
    ...
    def sort_by_color_under_other(self, second_sort):
        ...
        return (
            Mushroom.objects.filter(pk__in=second_sort)
            .filter(
                Q(couleur_au_dessous_du_chapeau__icontains="rose")
                | Q(couleur_au_dessous_du_chapeau__icontains="bleu")
                | Q(couleur_au_dessous_du_chapeau__icontains="violet")
                | Q(couleur_au_dessous_du_chapeau__icontains="vert")
                | Q(couleur_au_dessous_du_chapeau__icontains="rouille")
            )
            .order_by("espece")
        )
    ...
    def sort_by_ring(self, third_sort):
        ...
        return (
            Mushroom.objects.filter(pk__in=third_sort)
            .filter(presence_d_un_anneau__exact="oui")
            .order_by("espece")
        )
    ...
    def sort_by_not_ring(self, third_sort):
        ...
        return (
            Mushroom.objects.filter(pk__in=third_sort)
            .filter(presence_d_un_anneau__exact="non")
            .order_by("espece")
        )
